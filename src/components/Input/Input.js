        ...
        ? ( 
          <div>
            ...
            <form id="send-container">
              ...
              />
              <button type="submit" id="send-button" role="img" data-tip data-for="sent" onClick={e => sendMessageAndCloseEmojiContainer(e)}><span role="img" aria-label="emoji">🚀</span></button>
            </form>
          </div>
         )
        : ( 
